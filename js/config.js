...
const UPGRADE_DEFS = [
  { id: 'terminal', cost: 10, effect: 'click', value: 1, icon: 'fa-terminal', unlockAt: 0, rarity: 'common' },
  { id: 'cpu', cost: 25, effect: 'dps', value: 0.5, icon: 'fa-microchip', unlockAt: 0, rarity: 'common' },
  { id: 'scanner', cost: 50, effect: 'click', value: 2, icon: 'fa-qrcode', unlockAt: 0, rarity: 'common' },
  { id: 'firewall', cost: 100, effect: 'dps', value: 2, icon: 'fa-shield-hacked', unlockAt: 0, rarity: 'common' },
  { id: 'ai', cost: 250, effect: 'click', value: 5, icon: 'fa-brain', unlockAt: 0, rarity: 'common' },
  { id: 'botnet', cost: 500, effect: 'dps', value: 5, icon: 'fa-network-wired', unlockAt: 0, rarity: 'common' },
  { id: 'zeroday', cost: 1000, effect: 'click', value: 15, icon: 'fa-bug', unlockAt: 500, rarity: 'uncommon' },
  { id: 'quantum', cost: 2500, effect: 'dps', value: 15, icon: 'fa-atom', unlockAt: 1000, rarity: 'uncommon' },
  { id: 'smith', cost: 5000, effect: 'click', value: 50, icon: 'fa-sunglasses', unlockAt: 2500, rarity: 'uncommon' },
  { id: 'source', cost: 10000, effect: 'dps', value: 50, icon: 'fa-code', unlockAt: 5000, rarity: 'uncommon' },
  { id: 'critical', cost: 15000, effect: 'crit', value: 4, icon: 'fa-bolt', unlockAt: 10000, rarity: 'uncommon' },
  { id: 'sqlinjection', cost: 25000, effect: 'discount', value: 2, icon: 'fa-database', unlockAt: 10000, rarity: 'uncommon' },
  { id: 'trojan', cost: 40000, effect: 'autoclick', value: 1, icon: 'fa-horse-head', unlockAt: 20000, rarity: 'uncommon' },
  { id: 'sniffer', cost: 100000, effect: 'dps', value: 75, icon: 'fa-wifi', unlockAt: 75000, rarity: 'uncommon' },
  { id: 'bruteforce', cost: 250000, effect: 'click', value: 150, icon: 'fa-key', unlockAt: 150000, rarity: 'uncommon' },
  { id: 'ddos', cost: 750000, effect: 'dps', value: 500, icon: 'fa-skull', unlockAt: 400000, rarity: 'uncommon' },
  { id: 'ghost', cost: 2000000, effect: 'click', value: 400, icon: 'fa-ghost', unlockAt: 1000000, rarity: 'uncommon' },
  { id: 'kernel', cost: 80000, effect: 'mult_click', value: 1.15, icon: 'fa-gear', unlockAt: 40000, rarity: 'rare' },
  { id: 'zion', cost: 150000, effect: 'mult_dps', value: 1.15, icon: 'fa-city', unlockAt: 75000, rarity: 'rare' },
  { id: 'rootkit', cost: 300000, effect: 'offline', value: 15, icon: 'fa-user-secret', unlockAt: 150000, rarity: 'rare' },
  { id: 'evolution', cost: 5000000, effect: 'mult_click', value: 1.2, icon: 'fa-dna', unlockAt: 3000000, rarity: 'rare' },
  { id: 'transcend', cost: 10000000, effect: 'mult_dps', value: 1.2, icon: 'fa-arrow-up', unlockAt: 5000000, rarity: 'rare' },
  { id: 'codered', cost: 10000000, effect: 'click', value: 5000, icon: 'fa-virus', unlockAt: 5000000, rarity: 'rare' },
  { id: 'neural', cost: 25000000, effect: 'dps', value: 10000, icon: 'fa-wave-square', unlockAt: 12000000, rarity: 'rare' },
  { id: 'phantom', cost: 50000000, effect: 'click', value: 1000, icon: 'fa-eye-slash', unlockAt: 25000000, rarity: 'rare' },
  { id: 'overmind', cost: 100000000, effect: 'dps', value: 500, icon: 'fa-crown', unlockAt: 25000000, rarity: 'rare' },
  { id: 'rhythm', cost: 5000, effect: 'click', value: 20, icon: 'fa-music', unlockAt: 2500, maxLevel: 10, rarity: 'rare' },
  { id: 'flow', cost: 20000, effect: 'dps', value: 20, icon: 'fa-water', unlockAt: 10000, maxLevel: 10, rarity: 'rare' },
  { id: 'momentum', cost: 100000, effect: 'clickDps', value: 10, icon: 'fa-forward', unlockAt: 50000, maxLevel: 10, rarity: 'rare' },
  { id: 'adrenaline', cost: 500000, effect: 'comboBoost', value: 0.02, icon: 'fa-heart-pulse', unlockAt: 250000, maxLevel: 10, rarity: 'rare' },
  { id: 'backdoor', cost: 50000, effect: 'discount', value: 1, icon: 'fa-door-open', unlockAt: 20000, maxLevel: 5, rarity: 'rare' },
  { id: 'wormhole', cost: 2000000, effect: 'critDmg', value: 0.5, icon: 'fa-circle-nodes', unlockAt: 1000000, maxLevel: 5, rarity: 'rare' },
  { id: 'worm', cost: 500000000, effect: 'click', value: 500000, icon: 'fa-worm', unlockAt: 200000000, rarity: 'epic' },
  { id: 'sentinel', cost: 5000000000, effect: 'dps', value: 500000, icon: 'fa-shield', unlockAt: 2000000000, rarity: 'epic' },
  { id: 'oracle', cost: 50000000000, effect: 'mult_click', value: 1.5, icon: 'fa-eye', unlockAt: 20000000000, rarity: 'epic' },
  { id: 'apocalypse', cost: 100000000000, effect: 'click', value: 100000, icon: 'fa-skull-crossbones', unlockAt: 50000000000, rarity: 'epic' },
  { id: 'collective', cost: 500000000000, effect: 'dps', value: 50000, icon: 'fa-people-group', unlockAt: 200000000000, rarity: 'epic' },
  { id: 'prime', cost: 1000000000000, effect: 'mult_dps', value: 1.5, icon: 'fa-star', unlockAt: 500000000000, rarity: 'epic' },
  { id: 'cortex', cost: 5000000, effect: 'critDmg', value: 0.3, icon: 'fa-sliders', unlockAt: 2500000, maxLevel: 5, rarity: 'epic' },
  { id: 'leech', cost: 50000000, effect: 'autoclick', value: 1, icon: 'fa-fill-drip', unlockAt: 25000000, rarity: 'epic' },
  { id: 'parasite', cost: 500000000, effect: 'autoSpeed', value: 300, icon: 'fa-biohazard', unlockAt: 200000000, maxLevel: 5, rarity: 'epic' },
  { id: 'proxy', cost: 5000000000, effect: 'discount', value: 2, icon: 'fa-arrow-right-arrow-left', unlockAt: 2000000000, maxLevel: 5, rarity: 'epic' },
  { id: 'turbo', cost: 10000000, effect: 'autoSpeed', value: 500, icon: 'fa-gauge-high', unlockAt: 5000000, maxLevel: 5, rarity: 'epic' },
  { id: 'nexus', cost: 100000000, effect: 'clickDps', value: 2000, icon: 'fa-circle-dot', unlockAt: 50000000, maxLevel: 5, rarity: 'epic' },
  { id: 'overdrive', cost: 50000000000, effect: 'click', value: 50000, icon: 'fa-gem', unlockAt: 20000000000, rarity: 'epic' },
  { id: 'grid', cost: 50000000000, effect: 'dps', value: 25000, icon: 'fa-border-all', unlockAt: 20000000000, rarity: 'epic' },
  { id: 'cipher', cost: 10000000000000, effect: 'mult_click', value: 2, icon: 'fa-lock', unlockAt: 5000000000000, rarity: 'legendary', maxLevel: 5, legendaryReq: { achievements: ['elite_hacker'], minPrestige: 1 } },
  { id: 'keymaker', cost: 100000000000000, effect: 'mult_dps', value: 2, icon: 'fa-keys', unlockAt: 50000000000000, rarity: 'legendary', maxLevel: 5, legendaryReq: { achievements: ['completionist'], minPrestige: 3 } },
  { id: 'singularity', cost: 50000000000000, effect: 'click', value: 10000000, icon: 'fa-circle-radiation', unlockAt: 20000000000000, rarity: 'legendary', maxLevel: 10, legendaryReq: { upgrades: ['oracle'] } },
  { id: 'infinite', cost: 50000000000000, effect: 'dps', value: 5000000, icon: 'fa-infinity', unlockAt: 20000000000000, rarity: 'legendary', maxLevel: 10, legendaryReq: { upgrades: ['prime'] } },
  { id: 'omega', cost: 1000000000000000, effect: 'mult_click', value: 3, icon: 'fa-ring', unlockAt: 500000000000000, rarity: 'legendary', maxLevel: 3, legendaryReq: { upgrades: ['cipher', 'singularity'] } },
  { id: 'genesis', cost: 1000000000000000, effect: 'mult_dps', value: 3, icon: 'fa-seedling', unlockAt: 500000000000000, rarity: 'legendary', maxLevel: 3, legendaryReq: { upgrades: ['keymaker', 'infinite'] } },
];
...
const VISUAL_SKINS = [
  { id: 'default', nameKey: 'skinDefault', cost: 0, colors: { head: '200, 255, 200', body: '0, 255, 0', alpha: 0.3, shadow: '#00ff00', scanline: 'rgba(0, 255, 0, 0.03)', ui: { accent: '#ff8800', bright: '#ffaa00', glow: '#ff6600', dim: '#885500', dark: '#553300', bg: '#1a0e00' } }, speedMult: 1 },
  { id: 'hacker', nameKey: 'skinHacker', cost: 50000, colors: { head: '100, 255, 100', body: '0, 200, 0', alpha: 0.4, shadow: '#00ff00', scanline: 'rgba(0, 255, 0, 0.05)', ui: { accent: '#00cc44', bright: '#00ff55', glow: '#009933', dim: '#006622', dark: '#003311', bg: '#000a00' } }, speedMult: 1.2 },
  { id: 'night', nameKey: 'skinNight', cost: 100000, colors: { head: '100, 200, 255', body: '0, 150, 255', alpha: 0.35, shadow: '#0099ff', scanline: 'rgba(0, 150, 255, 0.04)', ui: { accent: '#0088ff', bright: '#33aaff', glow: '#0066cc', dim: '#004488', dark: '#002255', bg: '#000511' } }, speedMult: 1 },
  { id: 'firewall', nameKey: 'skinFirewall', cost: 250000, colors: { head: '255, 150, 100', body: '255, 80, 0', alpha: 0.35, shadow: '#ff4400', scanline: 'rgba(255, 68, 0, 0.04)', ui: { accent: '#ff4400', bright: '#ff6633', glow: '#cc3300', dim: '#992200', dark: '#551100', bg: '#1a0500' } }, speedMult: 1.5 },
  { id: 'neon', nameKey: 'skinNeon', cost: 500000, colors: { head: '255, 100, 255', body: '200, 0, 255', alpha: 0.35, shadow: '#cc00ff', scanline: 'rgba(200, 0, 255, 0.04)', ui: { accent: '#aa00ff', bright: '#cc33ff', glow: '#8800cc', dim: '#660099', dark: '#330055', bg: '#0a0011' } }, speedMult: 1 },
  { id: 'golden', nameKey: 'skinGolden', cost: 1000000, colors: { head: '255, 240, 150', body: '255, 210, 0', alpha: 0.4, shadow: '#ffcc00', scanline: 'rgba(255, 204, 0, 0.05)', ui: { accent: '#ffcc00', bright: '#ffdd33', glow: '#ddaa00', dim: '#aa8800', dark: '#665500', bg: '#080500' } }, speedMult: 1 },
  { id: 'glitch', nameKey: 'skinGlitch', cost: 5000000, colors: { head: '0, 255, 0', body: '255, 0, 0', alpha: 0.5, shadow: '#ff0000', scanline: 'rgba(255, 0, 0, 0.06)', ui: { accent: '#ff0044', bright: '#ff3377', glow: '#cc0033', dim: '#880022', dark: '#440011', bg: '#0a0002' } }, speedMult: 2 },
  { id: 'cyber', nameKey: 'skinCyber', cost: 750000, colors: { head: '150, 255, 255', body: '0, 200, 200', alpha: 0.35, shadow: '#00ccbb', scanline: 'rgba(0, 204, 187, 0.04)', ui: { accent: '#00ccaa', bright: '#33ddbb', glow: '#00aa88', dim: '#007766', dark: '#003322', bg: '#000a08' } }, speedMult: 1.3 },
  { id: 'toxic', nameKey: 'skinToxic', cost: 1500000, colors: { head: '255, 150, 200', body: '255, 0, 100', alpha: 0.35, shadow: '#ff0088', scanline: 'rgba(255, 0, 136, 0.04)', ui: { accent: '#ff0088', bright: '#ff33aa', glow: '#cc0066', dim: '#990055', dark: '#550033', bg: '#0a0005' } }, speedMult: 1.3 },
  { id: 'blood', nameKey: 'skinBlood', cost: 2000000, colors: { head: '255, 100, 100', body: '200, 30, 30', alpha: 0.4, shadow: '#cc2222', scanline: 'rgba(204, 34, 34, 0.05)', ui: { accent: '#cc2222', bright: '#ee4444', glow: '#aa1111', dim: '#881111', dark: '#550808', bg: '#0a0000' } }, speedMult: 1.3 },
  { id: 'void', nameKey: 'skinVoid', cost: 3000000, colors: { head: '160, 180, 240', body: '80, 100, 200', alpha: 0.35, shadow: '#5566cc', scanline: 'rgba(85, 102, 204, 0.04)', ui: { accent: '#5566cc', bright: '#7788ee', glow: '#4455aa', dim: '#334488', dark: '#222255', bg: '#04060a' } }, speedMult: 1.1 },
  { id: 'ice', nameKey: 'skinIce', cost: 4000000, colors: { head: '255, 200, 180', body: '255, 120, 80', alpha: 0.3, shadow: '#ff7755', scanline: 'rgba(255, 119, 85, 0.03)', ui: { accent: '#ff7755', bright: '#ff9977', glow: '#dd5533', dim: '#aa4422', dark: '#662211', bg: '#0a0301' } }, speedMult: 1.2 },
  { id: 'frost', nameKey: 'skinFrost', cost: 6000000, colors: { head: '200, 200, 190', body: '130, 130, 110', alpha: 0.3, shadow: '#888877', scanline: 'rgba(136, 136, 119, 0.03)', ui: { accent: '#888877', bright: '#aaaa99', glow: '#666655', dim: '#555544', dark: '#333322', bg: '#060605' } }, speedMult: 1 },
];
...
const EVENT_DEFS = [
  { id: 'data_leak', dur: 30, chance: 0.25, descKey: 'eventLeak', icon: 'fa-triangle-exclamation' },
  { id: 'crypto_crash', dur: 60, chance: 0.25, descKey: 'eventCrash', icon: 'fa-arrow-trend-down' },
  { id: 'overclock', dur: 15, chance: 0.2, descKey: 'eventOverclock', icon: 'fa-gauge' },
  { id: 'windfall', dur: 0, chance: 0.15, descKey: 'eventWindfall', icon: 'fa-sack-dollar' },
  { id: 'ddos_attack', dur: 30, chance: 0.15, descKey: 'eventDdos', icon: 'fa-fire' },
];
...
const SYNERGY_DEFS = [
  { id: 'scanner_cpu', nameKey: 'synergyScannerName', icon: 'fa-bolt', reqs: [{ id: 'scanner', lvl: 5 }, { id: 'cpu', lvl: 1 }] },
  { id: 'architect', nameKey: 'synergyArchName', icon: 'fa-cubes', reqs: [] },
  { id: 'overdrive_grid', nameKey: 'synergyOverdriveName', icon: 'fa-forward-fast', reqs: [{ id: 'overdrive', lvl: 1 }, { id: 'grid', lvl: 1 }] },
  { id: 'cipher_keymaker', nameKey: 'synergyCipherName', icon: 'fa-code-merge', reqs: [{ id: 'cipher', lvl: 1 }, { id: 'keymaker', lvl: 1 }] },
  { id: 'combo_master', nameKey: 'synergyComboName', icon: 'fa-trophy', reqs: [{ id: 'rhythm', lvl: 5 }, { id: 'flow', lvl: 5 }, { id: 'momentum', lvl: 5 }, { id: 'adrenaline', lvl: 5 }] },
  { id: 'meta_stack', nameKey: 'synergyMetaName', icon: 'fa-layer-group', reqs: [{ id: 'backdoor', lvl: 3 }, { id: 'wormhole', lvl: 3 }, { id: 'turbo', lvl: 3 }, { id: 'nexus', lvl: 3 }] },
];
